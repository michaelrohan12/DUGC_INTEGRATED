...
class HomepageDugc extends React.Component {
  ...
  check = async (e) => {
    ...
    if (this.choice === "graf") {
      ...
      dataID2 =
        prevYear + "-" + this.sem + "-" + this.course + "-" + this.assets;
      data1 = [];
      data2 = [];
      dataGrad = [[], [], [], [], []];
        ...
        await fetch("http://localhost:1999/cie4", {
          ...
          .then(async (data) => {
            ...
            for (var i = 0; i < jsonres.length; i++) {
              ...
              } else data2.push(jsonres[i]["class_avg"]);
            }
      ...
      dataID2 =
        prevYear2 + "-" + this.sem + "-" + this.course + "-" + this.assets;
      ...
      if (assets_global === "CIE") URL = "http://localhost:1999/cie4";
      else URL = "http://localhost:1999/api";
      ...
      for (var i = 0; i < numOfCourses; i++) {
        dataID1 =
          this.year + "-" + this.sem + "-" + courses[i] + "-" + this.assets;
        var prevYear3 = parseInt(this.year) - 1;
        dataID2 =
          prevYear3 + "-" + this.sem + "-" + courses[i] + "-" + this.assets;
        dataIDS = [{ id1: dataID1, id2: dataID2 }];
  ...
  render() {
    return (
      <>
        ...
        <h1 style={{ marginTop: "8rem", marginLeft: "33rem" }}>
          DUGC Dashboard
        </h1>
        <div>
        ...
        <div id="contents" style={{ marginTop: "5rem" }}>
          ...
          >
            <section>
              <p id="message" style={{ color: "black", textAlign: "center" }}>
                Select Options to View Analysis
              </p>
              <form name="options" onSubmit={this.check}>
                ...
                <div style={{ textAlign: "center" }}>
                  <button id="" className="btn btn-primary" type="submit">
                    Analyse
                  </button>
                </div>
              </form>
...
class Chart extends React.Component {
  ...
  classAverage = () => {
    ...
    optionsChange.plugins.title.text =
      subject_global + " Class Average Analysis";
  ...
  divA = () => {
    ...
    const dataAlys = { ...this.state.dataAnalysis };
    optionsChange.plugins.title.text =
      subject_global + " Division A Grade Analysis";
    ...
    else dataAlys.labels = ["S", "A", "B", "C", "D"];
  ...
  divB = () => {
    ...
    const dataAlys = { ...this.state.dataAnalysis };
    optionsChange.plugins.title.text =
      subject_global + " Division B Grade Analysis";
  ...
  divC = () => {
    ...
    const dataAlys = { ...this.state.dataAnalysis };
    optionsChange.plugins.title.text =
      subject_global + " Division C Grade Analysis";
  ...
  divD = () => {
    ...
    const dataAlys = { ...this.state.dataAnalysis };
    optionsChange.plugins.title.text =
      subject_global + " Division D Grade Analysis";
  ...
  divE = () => {
    ...
    const dataAlys = { ...this.state.dataAnalysis };
    optionsChange.plugins.title.text =
      subject_global + " Division E Grade Analysis";
    ...
    <div style={{ height: "90%", width: "90%", "font-size": "20px" }}>
      <table id="consolidated-table">
        <tr style={{ color: "black" }}>
          ...
          <th style={{ "text-align": "center" }} colspan="50">
            No of students scoring marks
          </th>
        </tr>
        <tr style={{ color: "black" }}>
  ...
  return (
    <div style={{ height: "90%", width: "90%", "font-size": "20px" }}>
      <table id="consolidated-table">
        ...
        <tr style={{ color: "black" }}>
          <td colspan="7">A-div</td>
          <td colspan="7">B-div</td>
          <td colspan="7">C-div</td>
          <td colspan="7">D-div</td>
          <td colspan="7  ">E-div</td>
        </tr>
        <tr style={{ color: "black" }}>
          <td>S</td>
          <td>A</td>
