...
import MakeApproval from "./makeUpApproval.component";

export default class MakeApporval1 extends Component {
  render() {
    return (
      <div>
        ...
        <nav className="navbar navbar-dark bg-info navbar-expand-lg">
          <Link to="/makeForm" className="navbar-brand text-dark">
            Make up minor
          </Link>
          <div className="collpase navbar-collapse text-dark">
            <ul className="navbar-nav mr-auto text-dark">
              {/* <li className="navbar-item text-dark">
                <Link to="/makeForm" className="nav-link text-dark">
                  Application
                </Link>
              </li> */}
              {/* <li>
              ...
              <li>
                <Link to="/makeApporval" className="nav-link text-dark">
                  MakeUp Approval
                </Link>
              </li>
              <li>
                <Link to="/makePrint" className="nav-link text-dark">
                  MakeUp Print
                </Link>
              </li>
            </ul>
